          ...
          <div className="col-12">
            <div className="single-blog-card">
              ...
              <p>
                ...
                calça jeans e não é à toa, já que foi responsável por criar essa
                peça de roupa, no ano de 1873. Ficou curioso para saber mais?
                Então você precisa continuar lendo esse artigo que o Shopping
                Eldorado Store preparou!
              </p>
            </div>
          </div>
        </div>
