              ...
              <div className="policy">
                ...
                <div>
                  ...
                  <p>
                    ...
                    nome, endereço de e-mail, endereço de entrega e informações
                    de pagamento.
                  </p>
                  <h5 className="mt-5 mb-3">3. Uso das Informações</h5>
                  <p>
                    Usamos suas informações para processar pedidos, fornecer
                    atendimento ao cliente, enviar atualizações sobre seu pedido
                    e ofertas promocionais, e melhorar nossos serviços
                  </p>
                  ...
                  <p>
                    ...
                    exceto conforme necessário para processar seu pedido,
                    cumprir exigências legais ou proteger nossos direitos.
                  </p>
