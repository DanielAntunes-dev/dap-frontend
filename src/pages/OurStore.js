...
import grid4items from "../images/svg/gr4.svg";
import grid3items from "../images/svg/gr3.svg";
import grid2items from "../images/svg/gr2.svg";
import grid1item from "../images/svg/gr.svg";
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-10">
                  ...
                  <select name="" className="form-control form-select" id="">
                    ...
                    <option value="created-descending">Novo pro Antigo</option>
                  </select>
                </div>
                <div className="d-flex align-items-center gap-10">
